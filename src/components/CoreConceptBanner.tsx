...
export const CoreConceptBanner: React.FC = () => {
  return (
    <section
      id="core-concept"
      className="py-10 bg-emerald-950/20 border-b border-emerald-900/40"
      aria-label="第四章核心理念"
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="rounded-2xl border border-emerald-800/60 bg-gradient-to-br from-emerald-900/40 via-stone-900/60 to-stone-900/80 p-6 sm:p-8 shadow-md">
          {/* Top Heading */}
          ...
          {/* 5-Step Core Flow */}
          <div className="bg-stone-900/80 rounded-xl p-4 sm:p-5 border border-stone-800 mb-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 text-center">
              <div className="bg-stone-800/90 rounded-lg p-3 border border-stone-700/80 flex flex-col items-center">
              ...
              <div className="col-span-2 sm:col-span-1 bg-stone-800/90 rounded-lg p-3 border border-stone-700/80 flex flex-col items-center">
