    ...
    <figure className="my-6 rounded-2xl border border-slate-800 bg-slate-900/80 p-4 sm:p-6 shadow-sm">
      <div className="w-full overflow-hidden">
        ...
        >
          ...
          {/* Background */}
          <rect width="800" height="490" rx="12" fill="#0b1015" />
          ...
          <g transform="translate(36, 85)">
            <rect width="728" height="62" rx="8" fill="#0f172a" stroke="#334155" strokeWidth="1.5" />
            ...
            <text x="178" y="26" fill="#f1f5f9" fontSize="12" fontWeight="700">
              回答核心：大尺度天氣系統（高壓、鋒面、低壓槽、西南氣流）
            </text>
            <text x="178" y="46" fill="#94a3b8" fontSize="11">
          ...
          <g transform="translate(36, 436)">
            <rect width="728" height="42" rx="6" fill="#062e24" stroke="#059669" />
            <text x="20" y="26" fill="#6ee7b7" fontSize="12" fontWeight="700">
