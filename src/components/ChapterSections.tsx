  ...
  return (
    <div className="space-y-16 max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <section id="sec-01" className="scroll-mt-20" aria-labelledby="heading-sec-01">
        ...
        <h2 id="heading-sec-01" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          01 為什麼登山需要氣象判讀
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6 not-prose">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 shadow-xs">
              <div className="flex items-center space-x-2 text-amber-400 font-bold text-sm mb-1.5">
          ...
          <h3 className="text-lg font-bold text-stone-100 mt-6 mb-2">
            氣象判讀的核心價值：不是算命，而是管理風險
          </h3>
          <p>
            許多初學者常有一種誤解，以為學習氣象判讀是為了「準確預測每小時的晴雨」。然而大氣科學在複雜高山地形中本就具有混沌性，**氣象判讀的核心不是預測，而是判斷**。
          </p>
          <div className="p-4 rounded-xl bg-emerald-950/40 border-l-4 border-emerald-500 text-emerald-200 my-4 text-sm font-medium">
            <span className="font-bold text-emerald-300">AMNA 教育理念：</span>「預報是資訊，現場是證據，判斷才是能力。」優秀的登山者從不賭天氣，而是依據手中的資訊與眼前的證據，替自己與隊友保留充足的時間與撤退餘裕。
          </div>
        </div>
      ...
      {/* SECTION 02 */}
      {/* ======================================================== */}
      <section id="sec-02" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-02">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 02</span>
          <span>·</span>
          <span>物理機制</span>
        </div>
        <h2 id="heading-sec-02" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          02 認識山岳氣象特性
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="inline-block px-4 py-2 bg-slate-900 rounded-lg font-mono text-sm font-bold text-emerald-400 border border-slate-800 my-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 my-4 not-prose">
            <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl text-center">
              <div className="text-xs text-stone-400">海平面基準</div>
              <div className="text-lg font-bold font-mono text-stone-100 mt-0.5">0m ≈ 25°C</div>
              <div className="text-[11px] text-stone-500 mt-1">平地日常常態</div>
            </div>
            <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl text-center">
              <div className="text-xs text-stone-400">中海拔林道</div>
              <div className="text-lg font-bold font-mono text-emerald-400 mt-0.5">1500m ≈ 15°C</div>
              <div className="text-[11px] text-stone-500 mt-1">舒適但水氣易凝結</div>
            </div>
            <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl text-center">
              <div className="text-xs text-stone-400">百岳基線</div>
              <div className="text-lg font-bold font-mono text-sky-400 mt-0.5">3000m ≈ 5°C</div>
              <div className="text-[11px] text-stone-500 mt-1">需嚴格保暖裝備</div>
            </div>
            <div className="p-3 bg-slate-900/80 border border-slate-800 rounded-xl text-center">
              <div className="text-xs text-stone-400">最高峰稜線</div>
              <div className="text-lg font-bold font-mono text-indigo-400 mt-0.5">3800m ≈ 0°C</div>
              <div className="text-[11px] text-stone-500 mt-1">接近冰點結霜風險</div>
            </div>
          </div>
          <p className="text-xs text-amber-300 font-semibold bg-amber-950/40 p-2.5 rounded border border-amber-800/60">
      ...
      {/* SECTION 03 */}
      {/* ======================================================== */}
      <section id="sec-03" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-03">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 03</span>
          <span>·</span>
          <span>情資蒐集</span>
        </div>
        <h2 id="heading-sec-03" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          03 登山前如何取得氣象資訊
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="p-4 rounded-xl bg-sky-950/40 border-l-4 border-sky-500 text-sky-200 my-4 text-sm font-medium">
            <span className="font-bold text-sky-300">情報金律：</span>「不同資料回答不同問題；交叉比對 ＞ 單一資訊。」
          </div>
          ...
          <div className="space-y-3 not-prose my-4">
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <span className="font-bold text-stone-100 text-sm">1. 中央氣象署 (CWA) 地面天氣圖與警特報</span>
                <p className="text-xs text-stone-400 mt-0.5">回答：宏觀大氣系統（高壓、冷鋒、滯留鋒、颱風路徑）與法定豪大雨警報。</p>
              </div>
              <span className="text-xs px-2.5 py-1 bg-sky-950/80 text-sky-300 border border-sky-800/50 rounded font-mono self-start sm:self-auto flex-shrink-0">
                尺度：1~7天
              </span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <span className="font-bold text-stone-100 text-sm">2. 數值預報模型 (ECMWF 歐洲中尺度 / GFS 美國模式)</span>
                <p className="text-xs text-stone-400 mt-0.5">回答：目標山區 850hPa/700hPa 高空風速、相對濕度垂直剖面與降水量分佈。</p>
              </div>
              <span className="text-xs px-2.5 py-1 bg-emerald-950/80 text-emerald-300 border border-emerald-800/50 rounded font-mono self-start sm:self-auto flex-shrink-0">
                尺度：24~120小時
              </span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <span className="font-bold text-stone-100 text-sm">3. 氣象衛星雲圖 (Visible / IR / Water Vapor)</span>
                <p className="text-xs text-stone-400 mt-0.5">回答：雲系目前真實覆蓋邊界、高空卷雲推移與大氣水氣傳輸路徑。</p>
              </div>
              <span className="text-xs px-2.5 py-1 bg-amber-950/80 text-amber-300 border border-amber-800/50 rounded font-mono self-start sm:self-auto flex-shrink-0">
                尺度：過去1~6小時
              </span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <span className="font-bold text-stone-100 text-sm">4. 雷達回波圖 (Radar Reflectivity)</span>
                <p className="text-xs text-stone-400 mt-0.5">回答：哪裡正在降水？雨胞強度多少 dBZ？是否正在往登山路線快速逼近？</p>
              </div>
              <span className="text-xs px-2.5 py-1 bg-rose-950/80 text-rose-300 border border-rose-800/50 rounded font-mono self-start sm:self-auto flex-shrink-0">
                尺度：即時~未來1小時
              </span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <span className="font-bold text-stone-100 text-sm">5. 山區自動氣象站實測紀錄</span>
                <p className="text-xs text-stone-400 mt-0.5">回答：合歡山、玉山等鄰近測站現在幾度？過去 1 小時陣風幾級？是否有降水？</p>
              </div>
              <span className="text-xs px-2.5 py-1 bg-slate-800 text-stone-300 border border-slate-700 rounded font-mono self-start sm:self-auto flex-shrink-0">
                尺度：現地實況
              </span>
            </div>
          </div>
      ...
      {/* SECTION 04 */}
      {/* ======================================================== */}
      <section id="sec-04" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-04">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 04</span>
          <span>·</span>
          <span>實地觀測</span>
        </div>
        <h2 id="heading-sec-04" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          04 基礎氣象判讀能力
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 text-stone-200 my-4 text-sm font-semibold">
      ...
      {/* SECTION 05 */}
      {/* ======================================================== */}
      <section id="sec-05" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-05">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 05</span>
          <span>·</span>
          <span>高山環境風險</span>
        </div>
        <h2 id="heading-sec-05" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          05 高山常見危險天氣
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="space-y-4 my-6 not-prose">
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 shadow-xs">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-bold text-stone-100 flex items-center space-x-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-indigo-500" />
                  <span>1. 午後雷雨 (Convective Thunderstorms)</span>
                </span>
                <span className="text-xs px-2 py-0.5 bg-indigo-950/70 text-indigo-300 border border-indigo-800/50 rounded font-medium">夏秋典型</span>
              </div>
              <p className="text-xs text-stone-400 leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 shadow-xs">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs px-2 py-0.5 bg-teal-950/70 text-teal-300 border border-teal-800/50 rounded font-medium">稜線鞍部高發</span>
              </div>
              <p className="text-xs text-stone-400 leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 shadow-xs">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs px-2 py-0.5 bg-sky-950/70 text-sky-300 border border-sky-800/50 rounded font-medium">秋冬與鋒面過境</span>
              </div>
              <p className="text-xs text-stone-400 leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 shadow-xs">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs px-2 py-0.5 bg-slate-800 text-slate-300 border border-slate-700 rounded font-medium">常態高頻</span>
              </div>
              <p className="text-xs text-stone-400 leading-relaxed">
      ...
      {/* SECTION 06 */}
      {/* ======================================================== */}
      <section id="sec-06" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-06">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 06</span>
          <span>·</span>
          <span>動態管理</span>
        </div>
        <h2 id="heading-sec-06" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          06 天氣與行程決策
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="p-4 rounded-xl bg-emerald-950/80 border border-emerald-800/60 text-white font-medium my-4 text-sm leading-relaxed">
          ...
          <p className="font-bold text-stone-100">
            記住登山界最崇高的座右銘：<span className="text-emerald-400">安全撤退，也是成功登山。</span>
          </p>
        </div>
      ...
      {/* SECTION 07 */}
      {/* ======================================================== */}
      <section id="sec-07" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-07">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 07</span>
          <span>·</span>
          <span>破除迷思</span>
        </div>
        <h2 id="heading-sec-07" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          07 常見氣象判讀錯誤
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
      ...
      {/* SECTION 08 */}
      {/* ======================================================== */}
      <section id="sec-08" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-08">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 08</span>
          <span>·</span>
          <span>裝備與平台</span>
        </div>
        <h2 id="heading-sec-08" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          08 登山氣象工具介紹
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6 not-prose">
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
              ...
              <div className="text-[11px] text-stone-400 bg-slate-950 p-2 rounded border border-slate-800/80">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
              <div className="flex items-center space-x-2 text-stone-200 font-bold text-sm mb-2">
      ...
      {/* SECTION 09 */}
      {/* ======================================================== */}
      <section id="sec-09" className="scroll-mt-20 pt-8 border-t border-slate-800" aria-labelledby="heading-sec-09">
        <div className="flex items-center space-x-2 text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-2">
          <span>SECTION 09</span>
          <span>·</span>
          <span>本章核心精華</span>
        </div>
        <h2 id="heading-sec-09" className="text-2xl sm:text-3xl font-extrabold text-stone-100 tracking-tight mb-4">
          09 領隊氣象判讀流程
        </h2>
        <div className="prose prose-invert max-w-none text-stone-300 leading-relaxed space-y-4 text-base">
          ...
          <div className="p-4 bg-slate-900/80 rounded-xl border border-slate-800 font-medium text-sm text-stone-300 my-2 space-y-1">
          ...
          <h3 className="text-lg font-bold text-stone-100 mt-8 mb-2">
            階段二：行程中現地動態循環閉環 (On-trail Dynamic Loop)
          </h3>
          <p>
            到了山上，靜態的預報結束，動態的考驗開始。領隊必須啟動不間斷的觀察循環：
          </p>
          <div className="p-4 bg-amber-950/30 rounded-xl border border-amber-800/50 font-medium text-sm text-amber-200 my-2 space-y-1">
            <div className="flex items-center space-x-2">
